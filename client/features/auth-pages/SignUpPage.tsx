...
const SignUpPage = () => {
  ...
  return (
    <Box className={`${styles.signInPage}`}>
      ...
      <Typography variant='h3' className={`${styles.headingText}`}>Sign Up</Typography>
      ...
      <form className={`${styles.authViewForm}`}>
        <TextField placeholder='full name' variant='standard'></TextField>
        <TextField placeholder='email address' variant='standard'></TextField>
        <TextField placeholder='password' variant='standard'></TextField>
        <Button variant='contained' className={`${styles.formSubmitButton}`}>Create an Account</Button>
      </form>
