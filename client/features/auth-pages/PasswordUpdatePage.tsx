...
const PasswordUpdatePage = () => {
  ...
  return (
    <Box className={`${styles.signInPage}`}>
      ...
      <Typography variant='h3' mt={6} className={`${styles.headingText}`}>Reset your password.</Typography>

      <Typography sx={{ maxWidth: 400 }} mb={6} variant='body1'>Enter a valid username and password to reset your password.</Typography>

      <form className={`${styles.authViewForm}`}>
        <TextField placeholder='new password' variant='standard'></TextField>
        <TextField placeholder='confirm password' variant='standard'></TextField>
        <Button variant='contained' className={`${styles.formSubmitButton}`}>Update Password</Button>
      </form>
